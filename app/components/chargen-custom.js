...
export default Component.extend({
	...
	return { iconicf: this.get('char.custom.charicf'), race: this.get('char.custom.charrace'), cgedges: this.get('char.custom.cgedges'), cgedgesnofw: this.get('char.custom.cgedgesnofw'), cgedgesfw: this.get('char.custom.cgedgesfw'), cghind: this.get('char.custom.cghind'), cghindnofw: this.get('char.custom.cghindnofw'), cghindfw: this.get('char.custom.cghindfw') };
	},
