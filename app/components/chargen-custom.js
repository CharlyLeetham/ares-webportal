  ...
  onUpdate: function() {
	...
	actions: {
		...
		hindChanged(val) {
			...
			trexcludes = Object.values(charhind).filter(slots => slots.trexcludes != '');// Convert sysedges to an array and filter for any entries that match the new framework selected.			
